...
class SecuritySystem {
    ...
    recordFailedAttempt() {
        const now = new Date(); this.attemptData.attempts++; this.attemptData.lastAttempt = now.toISOString();
    ...
    isBlocked() {
        ...
        const blockUntil = new Date(this.attemptData.blockUntil); const now = new Date();
